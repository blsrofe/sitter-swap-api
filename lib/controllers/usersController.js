...
const getUser = (request, response, next) => {
  // const reqAuth = request.header("Authorization")
  // const authArray = reqAuth.split(" ")
  // const token = authArray[0]
  // const username = authArray[1]
  // console.log(User.authenticate(token, username))
  // if (User.authenticate(token, username)) {
